...
!function (a, b, c, d) {
  ...
  function e(a) {
    ...
    function a() {
  ...
  }(jQuery), b.Foundation = { name: "Foundation", version: "5.2.2", media_queries: { small: g(".foundation-mq-small").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), medium: g(".foundation-mq-medium").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), large: g(".foundation-mq-large").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), xlarge: g(".foundation-mq-xlarge").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), xxlarge: g(".foundation-mq-xxlarge").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, "") }, stylesheet: a("<style></style>").appendTo("head")[0].sheet, global: { namespace: d }, init: function init(a, b, c, d, e) {
      var f = [a, c, d, e],
          h = [];if (this.rtl = /rtl/i.test(g("html").attr("dir")), this.scope = a || this.scope, this.set_namespace(), b && "string" == typeof b && !/reflow/i.test(b)) this.libs.hasOwnProperty(b) && h.push(this.init_lib(b, f));else for (var i in this.libs) {
        h.push(this.init_lib(i, b));
      }return a;
    }, init_lib: function init_lib(b, c) {
    ...
    }, libs: {}, utils: { S: g, throttle: function throttle(a, b) {
      ...
      }, data_options: function data_options(b) {
        function c(a) {
          ...
          var b = Foundation.global.namespace;return a.data(b.length > 0 ? b + "-options" : "options");
            ...
            j = i(b);if ("object" == (typeof j === "undefined" ? "undefined" : _typeof(j))) return j;for (g = (j || ":").split(";"), e = g.length; e--;) {
      ...
      }, register_media: function register_media(b, c) {
        Foundation.media_queries[b] === d && (a("head").append('<meta class="' + c + '">'), Foundation.media_queries[b] = e(a("." + c).css("font-family")));
      }, add_custom_rule: function add_custom_rule(a, b) {
      ...
      }, image_loaded: function image_loaded(a, b) {
        var c = this,
...
}(jQuery, undefined, undefined.document), function (a, b, c) {
  "use strict";
  Foundation.libs.abide = { name: "abide", version: "5.2.2", settings: { live_validate: !0, focus_on_invalid: !0, error_labels: !0, timeout: 1e3, patterns: { alpha: /^[a-zA-Z]+$/, alpha_numeric: /^[a-zA-Z0-9]+$/, integer: /^[-+]?\d+$/, number: /^[-+]?\d*(?:\.\d+)?$/, card: /^(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$/, cvv: /^([0-9]){3,4}$/, email: /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/, url: /^(https?|ftp|file|ssh):\/\/(((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/, domain: /^([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$/, datetime: /^([0-2][0-9]{3})\-([0-1][0-9])\-([0-3][0-9])T([0-5][0-9])\:([0-5][0-9])\:([0-5][0-9])(Z|([\-\+]([0-1][0-9])\:00))$/, date: /(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))$/, time: /^(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}$/, dateISO: /^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2}$/, month_day_year: /^(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.](19|20)\d\d$/, color: /^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/ }, validators: { equalTo: function equalTo(a) {
          var b = c.getElementById(a.getAttribute(this.add_namespace("data-equalto"))).value,
              d = a.value,
              e = b === d;return e;
        } } }, timer: null, init: function init(a, b, c) {
      this.bindings(b, c);
    }, events: function events(b) {
      var c = this,
      ...
      var d = this.parse_patterns(a),
          ...
          h = /submit/.test(b.type);f.trigger("validated");for (var i = 0; e > i; i++) {
    ...
    }, parse_patterns: function parse_patterns(a) {
      for (var b = a.length, c = []; b--;) {
        c.push(this.pattern(a[b]));
      }return this.check_validation_and_apply_styles(c);
    }, pattern: function pattern(a) {
    ...
    }, check_validation_and_apply_styles: function check_validation_and_apply_styles(b) {
    ...
    }, valid_checkbox: function valid_checkbox(a, b) {
      var a = this.S(a),
    ...
    }, valid_radio: function valid_radio(a) {
    ...
    }, valid_equal: function valid_equal(a, b, d) {
    ...
    }, valid_oneof: function valid_oneof(a, b, c, d) {
      var a = this.S(a),
...
}(jQuery, undefined, undefined.document), function (a) {
  "use strict";
  Foundation.libs.accordion = { name: "accordion", version: "5.2.2", settings: { active_class: "active", multi_expand: !1, toggleable: !0 }, init: function init(a, b, c) {
      this.bindings(b, c);
...
}(jQuery, undefined, undefined.document), function (a, b) {
  "use strict";
  Foundation.libs.alert = { name: "alert", version: "5.2.2", settings: { callback: function callback() {} }, init: function init(a, b, c) {
      this.bindings(b, c);
    }, events: function events() {
      var c = this,
  ...
  Foundation.libs.clearing = { name: "clearing", version: "5.2.2", settings: { templates: { viewing: '<a href="#" class="clearing-close">&times;</a><div class="visible-img" style="display: none"><div class="clearing-touch-label"></div><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" alt="" /><p class="clearing-caption"></p><a href="#" class="clearing-main-prev"><span></span></a><a href="#" class="clearing-main-next"><span></span></a></div>' }, close_selectors: ".clearing-close", touch_label: "", init: !1, locked: !1 }, init: function init(a, b, c) {
    ...
    }, swipe_events: function swipe_events() {
      var a = this,
    ...
    }, fix_height: function fix_height(a) {
    ...
    }, update_paddles: function update_paddles(a) {
    ...
    }, center_and_label: function center_and_label(a, b) {
    ...
    }, direction: function direction(a, b, c) {
      var d,
          e = this.S("li", a),
    ...
    }, adjacent: function adjacent(a, b) {
  ...
  "use strict";
  Foundation.libs.dropdown = { name: "dropdown", version: "5.2.2", settings: { active_class: "open", align: "bottom", is_hover: !1, opened: function opened() {}, closed: function closed() {} }, init: function init(a, b, c) {
      ...
      } }, adjust_pip: function adjust_pip(a, b) {
  ...
  "use strict";
  Foundation.libs.equalizer = { name: "equalizer", version: "5.2.2", settings: { use_tallest: !0, before_height_change: a.noop, after_height_change: a.noop }, init: function init(a, b, c) {
  ...
  Foundation.libs.interchange = { name: "interchange", version: "5.2.2", cache: {}, images_loaded: !1, nodes_loaded: !1, settings: { load_attr: "interchange", named_queries: { "default": "only screen", small: Foundation.media_queries.small, medium: Foundation.media_queries.medium, large: Foundation.media_queries.large, xlarge: Foundation.media_queries.xlarge, xxlarge: Foundation.media_queries.xxlarge, landscape: "only screen and (orientation: landscape)", portrait: "only screen and (orientation: portrait)", retina: "only screen and (-webkit-min-device-pixel-ratio: 2),only screen and (min--moz-device-pixel-ratio: 2),only screen and (-o-min-device-pixel-ratio: 2/1),only screen and (min-device-pixel-ratio: 2),only screen and (min-resolution: 192dpi),only screen and (min-resolution: 2dppx)" }, directives: { replace: function replace(b, c, d) {
      ...
      var a = "";for (var b in this.settings.named_queries) {
      ...
      var b = this.cache;if (!this.images_loaded || !this.nodes_loaded) return void setTimeout(a.proxy(this.resize, this), 50);for (var c in b) {
    ...
    }, parse_params: function parse_params(a, b, c) {
      return [this.trim(a), this.convert_directive(b), this.trim(c)];
    }, convert_directive: function convert_directive(a) {
    ...
    }, trim: function trim(b) {
      return "string" == typeof b ? a.trim(b) : b;
    }, set_data_attr: function set_data_attr(a) {
      return a ? this.namespace.length > 0 ? this.namespace + "-" + this.settings.load_attr : this.settings.load_attr : this.namespace.length > 0 ? "data-" + this.namespace + "-" + this.settings.load_attr : "data-" + this.settings.load_attr;
    }, parse_data_attr: function parse_data_attr(a) {
  ...
  Foundation.libs.joyride = { name: "joyride", version: "5.2.2", defaults: { expose: !1, modal: !0, tip_location: "bottom", nub_position: "auto", scroll_speed: 1500, scroll_animation: "linear", timer: 0, start_timer_on_click: !0, start_offset: 0, next_button: !0, tip_animation: "fade", pause_after: [], exposed: [], tip_animation_fade_speed: 300, cookie_monster: !1, cookie_name: "joyride", cookie_domain: !1, cookie_expires: 365, tip_container: "body", abort_on_close: !0, tip_location_patterns: { top: ["bottom"], bottom: [], left: ["right", "top", "bottom"], right: ["left", "top", "bottom"] }, post_ride_callback: function post_ride_callback() {}, post_step_callback: function post_step_callback() {}, pre_step_callback: function pre_step_callback() {}, pre_ride_callback: function pre_ride_callback() {}, post_expose_callback: function post_expose_callback() {}, template: { link: '<a href="#close" class="joyride-close-tip">&times;</a>', timer: '<div class="joyride-timer-indicator-wrap"><span class="joyride-timer-indicator"></span></div>', tip: '<div class="joyride-tip-guide"><span class="joyride-nub"></span></div>', wrapper: '<div class="joyride-content-wrapper"></div>', button: '<a href="#" class="small button joyride-next-tip"></a>', modal: '<div class="joyride-modal-bg"></div>', expose: '<div class="joyride-expose-wrapper"></div>', expose_cover: '<div class="joyride-expose-cover"></div>' }, expose_add_class: "" }, init: function init(b, c, d) {
      ...
      var b = this,
        ...
        var f = a(this);this.settings = a.extend({}, b.defaults, b.data_options(f));for (var g = e; g--;) {
          b.settings[d[g]] = parseInt(b.settings[d[g]], 10);
        }b.create({ $li: f, index: c });
      }), !this.settings.start_timer_on_click && this.settings.timer > 0 ? (this.show("init"), this.startTimer()) : this.show("init")));
    }, resume: function resume() {
      this.set_li(), this.show();
    }, tip_template: function tip_template(b) {
    ...
    }, timer_instance: function timer_instance(b) {
    ...
    }, button_text: function button_text(b) {
    ...
    }, pos_default: function pos_default(c, d) {
    ...
    }, pos_phone: function pos_phone(b) {
    ...
    }, pos_modal: function pos_modal(a) {
    ...
    }, add_exposed: function add_exposed(b) {
      this.settings.exposed = this.settings.exposed || [], b instanceof a || "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) ? this.settings.exposed.push(b[0]) : "string" == typeof b && this.settings.exposed.push(b);
    }, remove_exposed: function remove_exposed(b) {
      var c, d;for (b instanceof a ? c = b[0] : "string" == typeof b && (c = b), this.settings.exposed = this.settings.exposed || [], d = this.settings.exposed.length; d--;) {
    ...
    }, nub_position: function nub_position(a, b, c) {
  ...
  "use strict";
  Foundation.libs["magellan-expedition"] = { name: "magellan-expedition", version: "5.2.2", settings: { active_class: "active", threshold: 0, destination_threshold: 20, throttle_delay: 30 }, init: function init(a, b, c) {
      Foundation.inherit(this, "throttle"), this.bindings(b, c);
    }, events: function events() {
      var c = this,
          d = c.S,
    ...
    }, data_attr: function data_attr(a) {
...
}(jQuery, undefined, undefined.document), function () {
  "use strict";
  Foundation.libs.offcanvas = { name: "offcanvas", version: "5.2.2", settings: {}, init: function init() {
      this.events();
    }, events: function events() {
      var a = this,
    ...
    }, click_toggle_class: function click_toggle_class(a, b) {
      a.preventDefault(), this.S(a.target).closest(".off-canvas-wrap").toggleClass(b);
    }, click_remove_class: function click_remove_class(a, b) {
  ...
  var d = function d() {},
      e = function e(d, _e) {
    if (d.hasClass(_e.slides_container_class)) return this;var h,
        i,
        j,
        k,
        l,
        ...
        n = d,
        o = 0,
        p = n.find("." + _e.active_slide_class).length > 0;m.cache = {}, m.slides = function () {
      return n.children(_e.slide_selector);
    }, p || m.slides().first().addClass(_e.active_slide_class), m.update_slide_number = function (b) {
      _e.slide_number && (i.find("span:first").text(parseInt(b) + 1), i.find("span:last").text(m.slides().length)), _e.bullets && (j.children().removeClass(_e.bullets_active_class), a(j.children().get(b)).addClass(_e.bullets_active_class));
    }, m.update_active_link = function (b) {
      var c = a('[data-orbit-link="' + m.slides().eq(b).attr("data-orbit-slide") + '"]');c.siblings().removeClass(_e.bullets_active_class), c.addClass(_e.bullets_active_class);
    }, m.build_markup = function () {
      n.wrap('<div class="' + _e.container_class + '"></div>'), h = n.parent(), n.addClass(_e.slides_container_class), n.addClass(_e.animation), _e.stack_on_small && h.addClass(_e.stack_on_small_class), _e.navigation_arrows && (h.append(a('<a href="#"><span></span></a>').addClass(_e.prev_class)), h.append(a('<a href="#"><span></span></a>').addClass(_e.next_class))), _e.timer && (k = a("<div>").addClass(_e.timer_container_class), k.append("<span>"), _e.timer_show_progress_bar && k.append(a("<div>").addClass(_e.timer_progress_class)), k.addClass(_e.timer_paused_class), h.append(k)), _e.slide_number && (i = a("<div>").addClass(_e.slide_number_class), i.append("<span></span> " + _e.slide_number_text + " <span></span>"), h.append(i)), _e.bullets && (j = a("<ol>").addClass(_e.bullets_container_class), h.append(j), j.wrap('<div class="orbit-bullets-container"></div>'), m.slides().each(function (b) {
        var c = a("<li>").attr("data-orbit-slide", b);j.append(c);
      }));
    }, m._prepare_direction = function (b) {
      var c = "next";o >= b && (c = "prev"), "slide" === _e.animation && setTimeout(function () {
        ...
        if (!_e.circular) return !1;b = 0;
      } else if (0 > b) {
        if (!_e.circular) return !1;b = d.length - 1;
      }var f = a(d.get(o)),
          g = a(d.get(b));return [c, f, g, b];
    }, m._goto = function (a, b) {
      if (null === a) return !1;if (m.cache.animating) return !1;if (a === o) return !1;"object" == _typeof(m.cache.timer) && m.cache.timer.restart();var c = m.slides();m.cache.animating = !0;var d = m._prepare_direction(a),
          f = d[0],
          g = d[1],
          h = d[2],
          a = d[3];if (d === !1) return !1;n.trigger("before-slide-change.fndtn.orbit"), _e.before_slide_change(), o = a, g.css("transitionDuration", _e.animation_speed + "ms"), h.css("transitionDuration", _e.animation_speed + "ms");var i = function i() {
        var d = function d() {
          b === !0 && m.cache.timer.restart(), m.update_slide_number(o), h.addClass(_e.active_slide_class), m.update_active_link(a), n.trigger("after-slide-change.fndtn.orbit", [{ slide_number: o, total_slides: c.length }]), _e.after_slide_change(o, c.length), setTimeout(function () {
            m.cache.animating = !1;
          }, 100);
        };n.height() != h.height() && _e.variable_height ? n.animate({ height: h.height() }, 250, "linear", d) : d();
      };if (1 === c.length) return i(), !1;var j = function j() {
        "next" === f && l.next(g, h, i), "prev" === f && l.prev(g, h, i);
      };h.height() > n.height() && _e.variable_height ? n.animate({ height: h.height() }, 250, "linear", j) : j();
    }, m.next = function (a) {
      ...
      var b = a(m.slides().get(o)),
          c = b.height();_e.variable_height || m.slides().each(function () {
        a(this).height() > c && (c = a(this).height());
      }), n.height(c);
    }, m.create_timer = function () {
      var a = new f(h.find("." + _e.timer_container_class), _e, m.timer_callback);return a;
    }, m.stop_timer = function () {
      "object" == _typeof(m.cache.timer) && m.cache.timer.stop();
    }, m.toggle_timer = function () {
      var a = h.find("." + _e.timer_container_class);a.hasClass(_e.timer_paused_class) ? ("undefined" == typeof m.cache.timer && (m.cache.timer = m.create_timer()), m.cache.timer.start()) : "object" == _typeof(m.cache.timer) && m.cache.timer.stop();
    }, m.init = function () {
      if (m.build_markup(), _e.timer && (m.cache.timer = m.create_timer(), Foundation.utils.image_loaded(this.slides().children("img"), m.cache.timer.start)), l = new g(_e, n), p) {
        var d = n.find("." + _e.active_slide_class),
            f = _e.animation_speed;_e.animation_speed = 1, d.removeClass("active"), m._goto(d.index()), _e.animation_speed = f;
      }h.on("click", "." + _e.next_class, m.next), h.on("click", "." + _e.prev_class, m.prev), _e.next_on_click && h.on("click", "[data-orbit-slide]", m.link_bullet), h.on("click", m.toggle_timer), _e.swipe && n.on("touchstart.fndtn.orbit", function (a) {
        ...
        _e.timer && _e.pause_on_hover && m.stop_timer();
      }).on("mouseleave.fndtn.orbit", function () {
        _e.timer && _e.resume_on_mouseout && m.cache.timer.start();
        ...
        h.prev("." + _e.preloader_class).css("display", "none"), m.update_slide_number(o), m.update_active_link(o), n.trigger("ready.fndtn.orbit");
      });
    }, m.init();
  },
      f = function f(a, b, c) {
  ...
  function e(a) {
    var b = /fade/i.test(a),
    ...
    }, key_up_off: function key_up_off() {
      ...
      var d = this;if (b) {
        ...
        var g = d.S("[" + d.attr_name() + "].open");if ("undefined" == typeof e.data("css-top") && e.data("css-top", parseInt(e.css("top"), 10)).data("offset", this.cache_offset(e)), this.key_up_on(e), e.trigger("open"), g.length < 1 && this.toggle_bg(e), "string" == typeof c && (c = { url: c }), "undefined" != typeof c && c.url) {
          var h = "undefined" != typeof c.success ? c.success : null;a.extend(c, { success: function success(b, c, i) {
    ...
    }, toggle_bg: function toggle_bg(b) {
      ...
      return this.namespace.length > 0 ? this.namespace + "-" + a : a;
    }, cache_offset: function cache_offset(a) {
  ...
  "use strict";
  Foundation.libs.slider = { name: "slider", version: "5.2.2", settings: { start: 0, end: 100, step: 1, initial: null, display_selector: "", on_change: function on_change() {} }, cache: {}, init: function init(a, b, c) {
    ...
    }, set_active_slider: function set_active_slider(a) {
      this.cache.active = a;
    }, remove_active_slider: function remove_active_slider() {
      this.cache.active = null;
    }, calculate_position: function calculate_position(b, c) {
      var d = this,
    ...
    }, normalized_percentage: function normalized_percentage(a, b, c) {
      return (a - b) / (c - b);
    }, normalized_value: function normalized_value(a, b, c, d) {
      var e = c - b,
          d = d,
          f = a * e,
          g = (f - f % d) / d,
    ...
    }, set_translate: function set_translate(b, c, d) {
      d ? a(b).css("-webkit-transform", "translateY(" + c + "px)").css("-moz-transform", "translateY(" + c + "px)").css("-ms-transform", "translateY(" + c + "px)").css("-o-transform", "translateY(" + c + "px)").css("transform", "translateY(" + c + "px)") : a(b).css("-webkit-transform", "translateX(" + c + "px)").css("-moz-transform", "translateX(" + c + "px)").css("-ms-transform", "translateX(" + c + "px)").css("-o-transform", "translateX(" + c + "px)").css("transform", "translateX(" + c + "px)");
    }, limit_to: function limit_to(a, b, c) {
      return Math.min(Math.max(a, b), c);
    }, initialize_settings: function initialize_settings(b) {
    ...
    }, set_initial_position: function set_initial_position(b) {
    ...
    }, set_value: function set_value(b) {
  ...
  "use strict";
  Foundation.libs.tab = { name: "tab", version: "5.2.2", settings: { active_class: "active", callback: function callback() {}, deep_linking: !1, scroll_to_content: !0, is_hover: !1 }, default_tab_hashes: [], init: function init(a, b, c) {
      var d = this,
      ...
      var b = this,
        ...
        var e = c(this).data(b.attr_name(!0) + "-init");if (e.deep_linking) {
          ...
          } else for (var i in b.default_tab_hashes) {
            b.toggle_active_tab(a("[" + b.attr_name() + "] > dd > a[href=" + b.default_tab_hashes[i] + "]").parent());
          }
        }
      });
    }, toggle_active_tab: function toggle_active_tab(c, e) {
      var f = this.S,
  ...
  "use strict";
  Foundation.libs.tooltip = { name: "tooltip", version: "5.2.2", settings: { additional_inheritable_classes: [], tooltip_class: ".tooltip", append_to: "body", touch_close_text: "Tap To Close", disable_for_touch: !1, hover_delay: 200, tip_template: function tip_template(a, b) {
        return '<span data-selector="' + a + '" class="' + Foundation.libs.tooltip.settings.tooltip_class.substring(1) + '">' + b + '<span class="nub"></span></span>';
      } }, cache: {}, init: function init(a, b, c) {
    ...
    }, ie_touch: function ie_touch() {
      return !1;
    }, showTip: function showTip(a) {
      this.getTip(a);return this.show(a);
    }, getTip: function getTip(b) {
      var c = this.selector(b),
          d = a.extend({}, this.settings, this.data_options(b)),
          e = null;return c && (e = this.S('span[data-selector="' + c + '"]' + d.tooltip_class)), "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) ? e : !1;
    ...
    }, reposition: function reposition(b, c, d) {
      var e, f, g, h, i;if (c.css("visibility", "hidden").show(), e = b.data("width"), f = c.children(".nub"), g = f.outerHeight(), h = f.outerHeight(), c.css(this.small() ? { width: "100%" } : { width: e ? e : "auto" }), i = function i(a, b, c, d, e) {
      ...
      return matchMedia(Foundation.media_queries.small).matches && !matchMedia(Foundation.media_queries.medium).matches;
    }, inheritable_classes: function inheritable_classes(b) {
    ...
    }, convert_to_touch: function convert_to_touch(b) {
      var c = this,
          d = c.getTip(b),
  ...
  "use strict";
  Foundation.libs.topbar = { name: "topbar", version: "5.2.2", settings: { index: 0, sticky_class: "sticky", custom_back_text: !0, back_text: "Back", is_hover: !0, mobile_show_parent_link: !1, scrolltop: !0, sticky_on: "all" }, init: function init(b, c, d) {
    ...
    }, is_sticky: function is_sticky(a, b, c) {
    ...
    }, timer: null, events: function events() {
      var c = this,
